...
export { default as TheHeaderCopy } from '../../components/TheHeader copy.vue'
...
export const LazyTheHeaderCopy = import('../../components/TheHeader copy.vue' /* webpackChunkName: "components/TheHeader copy" */).then(c => c.default || c)
